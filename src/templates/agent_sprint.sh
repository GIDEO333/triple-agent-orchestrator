...
echo "========================================"
echo "🚀 Initiating Triple Agent Sprint"
echo "========================================"
...
# ------------------------------------------------------------------------------
echo "👷 Spawning WORKER AGENT to execute the architecture plan..."
...
# ------------------------------------------------------------------------------
echo ""
echo "🔍 Worker Agent finished. Spawning QA AGENT for verification..."
...
# ------------------------------------------------------------------------------
echo ""
echo "🧹 Sprint Completed. Restoring standard Claude Code settings..."
rm .claude/settings.json

echo "========================================"
echo "📝 Please check 'qa_report.md' for results."
echo "========================================"
